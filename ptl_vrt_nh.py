...
def main():
    ...
    meteo_tool = meteotool_nh.MeteoTools(args["file"])
    ...
    #nh_map.contour_plot(lon, lat, surface_pressure, contour_type="pressure")
    ...
    #nh_map.vector_plot(lon, lat, ise_u_wind, ise_v_wind,
    #                   vector_interval=18,
    #                   vector_scale=0.00005,)
    #nh_map.color_line(lon, lat, ise_ptl_vorticity, line_value=1.0, color="#00793D")
    nh_map.hatch_plot(lon, lat,
