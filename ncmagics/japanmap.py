...
class JpMap:
    ...
    def __init__(self, color=False):
        ...
        dlon, dlat = 10, 10  # grid line interval.
        ...
        # chose near japan from the world map
    ...
    def gray_shade(self, x, y, z, label: str,
        ...
        hatch.set_clim(color_bar_label_min, color_bar_label_max) #color bar range.
    ...
    def hatch_plot(self, x, y, z, alpha=0.3):
        ...
        """
        x_2d, y_2d = np.meshgrid(x, y)
        self.ax.contourf(x_2d, y_2d, z, hatches='.',cmap='gray', alpha=alpha)
